...
class CfgCtrl(wx.Panel):
	...
	def setup(self,name):
		...
		if name=='Globals':
			...
			self.reload('GPL')
			print 'after GPL'
		elif self.name=='Asymptopia':
			print 'before Asymptopia'
			self.reload('Asymptopia')
			print 'after Asymptopia'
		
		print 'calling SetSizer'
		self.SetSizer(self.sizer)
		print 'caling SetAutoLayout'
	...
	def saveCB(self,e):
		...
		oufname=os.path.join(oufdir,'.mstation_config')
		ouf=open(oufname,'w')
