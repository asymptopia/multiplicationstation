...
def mkpkgs(w,h):
		...
		# tblow,dtblow,radius,  x0, dx0,  y0, dy0,   v,   dv, theta,dtheta,  ay,    r,  dr,   g,  dg,   b,  db,ttl,   tl,  n, dn,  ring,   tail colorlock
			[ 0.0,  .1,     4, w/2,   0,   h,   0,-180,    5, piov2,pi/30.,  30,  255, 000, 000, 000, 000, 000,  5,	  20,  1,  0, False,  False,  False],
			[ 4.0, 0.2,    	3, 999, 999, 999, 999, 100,   10,     0, twopi,  30,  255, 000, 255, 000, 255, 000,  2,	  10, 25,  0,  True,   True,   True],
			[ 4.5, 0.1,    	3, 999, 999, 999, 999, 030,   10,     0, twopi,  30,  255, 000, 000, 000, 255, 000,  2,	  10,  1,  0,  True,   True,   True],
		]
		...
		package=[
		# tblow,dtblow,radius,  x0, dx0,  y0, dy0,   v,   dv, theta,dtheta,  ay,    r,  dr,   g,  dg,   b,  db,ttl,   tl,  n, dn,  ring,   tail colorlock
			[ 0.0,  .1,     3, w/2,   0,   h,   0,-180,    5, piov2,pi/30.,  30,  255, 000, 255, 000, 255, 000,  4,	  20,  1,  0, False,   True,  False],
			[ 3.5, 0.2,    	4, 999, 999, 999, 999, 070,   10,     0, twopi,  30,  255, 000, 000, 000, 000, 000,  2,	  25, 40, 15,  True,   True,   True],
			[ 5.0, 0.3,    	1, 999, 999, 999, 999,   8,   01,     0, twopi,  30,  255, 000, 255, 000, 100, 000,  2,	   0,  2,  1, False,  False,   True],
		]
		pkgs.append({desc:package})
		...
		# tblow,dtblow,radius,  x0, dx0,  y0, dy0,   v,   dv, theta,dtheta,  ay,    r,  dr,   g,  dg,   b,  db,ttl,   tl,  n, dn,  ring,   tail colorlock
			...
			[ 2.5, 0.1,    	2, 999, 999, 999, 999,  10,    5,     0, twopi,  30,  200, 000, 100, 010, 000, 000,  3,	  20, 25, 01, False,    True,   True],
			[ 5.2, 1.0,    	1, 999, 999, 999, 999,  10,   10,     0, twopi,  30,  235, 020, 235, 020, 235, 020,  1,	  00, 25, 05, False,   False,   True],
		]
		pkgs.append({desc:package})
		...
		# tblow,dtblow,radius,  x0, dx0,  y0, dy0,   v,   dv, theta,dtheta,  ay,    r,  dr,   g,  dg,   b,  db,ttl,   tl,  n, dn,  ring,   tail colorlock
			[ 0.0,  .1,     3, w/2,   0,   h,   0,-180,    5, piov2,pi/30.,  30,  255, 000, 255, 000, 255, 000,  4,	  20,  1,  0, False,   True,  False],
			[ 3.5, 0.1,    	3, 999, 999, 999, 999,  40,   30,     0, twopi,  30,  255, 000, 255, 000, 255, 000,1.5,	   2, 30,  5,  True,   True,   True],
			[ 5.0, 1.5,    	2, 999, 999, 999, 999,  00,   00,     0, twopi,  30,  255, 000, 000, 000, 000, 000,  2,	   4,  1,  0, False,   True,   True],
		]
		pkgs.append({desc:package})
		...
		package=[
		# tblow,dtblow,radius,  x0, dx0,  y0, dy0,   v,   dv, theta,dtheta,  ay,    r,  dr,   g,  dg,   b,  db,ttl,   tl,  n, dn,  ring,   tail colorlock
			[ 0.0,  .1,     2, w/2,   0,   h,   0,-180,   15, piov2,pi/20.,  30,  255, 000, 255, 000, 255, 000,  5,	   5,  1,  0, False,   True,   True],
			[ 4.0, 0.1,    	3, 999, 999, 999, 999,  30,   15,     0, twopi,  30,  255, 000, 000, 000, 000, 000,  2,	   2, 50,  1, False,   True,   True],
			[ 5.5, 0.3,    	2, 999, 999, 999, 999,  10,   10,     0, twopi,  30,  255, 000, 255, 000, 255, 000,  1,	   1, 02, 02, False,   True,   False],
		]
		pkgs.append({desc:package})
		...
		package=[
		# tblow,dtblow,radius,  x0, dx0,  y0, dy0,   v,   dv, theta,dtheta,  ay,    r,  dr,   g,  dg,   b,  db,ttl,   tl,  n, dn,  ring,   tail colorlock
			[ 0.0,  .1,     3, w/2,   0,   h,   0,-150,    5, piov2,pi/30.,  30,  255, 000, 255, 000, 255, 000,  5,	  20,  1,  0, False,  False,  False],
			[ 4.2, 0.0,    	3, 999, 999, 999, 999,  50,   30,     0, twopi,  30,  100, 055, 100, 055, 255, 000,  3,	  10, 55,  1, False,   True,   False],
		]
		pkgs.append({desc:package})
		...
		package=[
		# tblow,dtblow,radius,  x0, dx0,  y0, dy0,   v,   dv, theta,dtheta,  ay,    r,  dr,   g,  dg,   b,  db,ttl,   tl,  n, dn,  ring,   tail colorlock
			[ 0.0,  .1,     1, w/2,   0,   h,   0,-150,    5, piov2,pi/30.,  30,  255, 000, 255, 000, 255, 000,  5,	   0,  1,  0, False,  False,  False],
			[ 3.0,  .1,    	3, 999, 999, 999, 999,  50,    0,     0, twopi,  30,  255, 000, 000, 000, 100, 100,  3,	  20, 30, 15,  True,   True,  False],
			[ 4.5,  .1,    	2, 999, 999, 999, 999,  10,   10,     0, twopi,  30,  200, 000, 255, 000, 200, 000,  3,	  03, 02, 01, False,   True,   True],
		]
		pkgs.append({desc:package})
		...
		package=[
		# tblow,dtblow,radius,  x0, dx0,  y0, dy0,   v,   dv, theta,dtheta,  ay,    r,  dr,   g,  dg,   b,  db,ttl,   tl,  n, dn,  ring,   tail colorlock
			[ 0.0, 0.0,     1, w/2,   0,   h,   0,-150,    5, piov2,pi/30.,  30,  155, 100, 155, 100, 155, 100,  5,	  30,  1,  0, False,   True,  False],
		...
		# tblow,dtblow,radius,  x0, dx0,  y0, dy0,   v,   dv, theta,dtheta,  ay,    r,  dr,   g,  dg,   b,  db,ttl,   tl,  n, dn,  ring,   tail colorlock
			[ 0.0,  .1,     3, w/2,   0,   h,   0,-150,    5, piov2,pi/30.,  30,  255, 000, 255, 000, 255, 000,  5,	  20,  1,  0, False,  False,  False],
			[ 3.0, 0.1,    	2, 999, 999, 999, 999,  10,   05,     0, twopi,  30,  000, 000, 000, 000, 200, 000,  3,	   5, 25, 12,  True,   True,   True],
			[ 4.0, 0.2,    	1, 999, 999, 999, 999,  40,   10,     0, twopi,  30,  255, 000, 255, 000, 255, 000,  1,   13,  3,  2,  True,   True,   True],
		]
		pkgs.append({desc:package})
